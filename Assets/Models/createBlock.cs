...
public class createBlock : MonoBehaviour {
    ...
    void createCube()
    {
        ...
        bool isBlock = false;
        int size = generationEngine.blockPosX.Length;



        for (var i = 0; i < size; i++)
        {
            if (generationEngine.blockPosY[i] == myPos.y & generationEngine.blockPosX[i] == myPos.x - 1) { isBlock = true; }
        }
        if (isBlock == false) { createQuad(cubeside.LEFT);}
        isBlock = false;
        //Divider
        ...
        if (isBlock == false) { createQuad(cubeside.RIGHT);}
        isBlock = false;
        //Divider
        ...
        for (var i = 0; i < size; i++)
        {
            if (generationEngine.blockPosY[i] == myPos.y & generationEngine.blockPosZ[i] == myPos.z + 1) { isBlock = true; }
        }
        if (isBlock == false) { createQuad(cubeside.FRONT);}
        isBlock = false;
        //Divider
        ...
        if (isBlock == false) { createQuad(cubeside.BACK);}
        isBlock = false;
